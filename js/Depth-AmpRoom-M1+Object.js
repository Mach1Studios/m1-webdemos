...
const audioFiles8 = ['Depth-AmpRoom/Medium/1', 'Depth-AmpRoom/Medium/2', 'Depth-AmpRoom/Medium/3', 'Depth-AmpRoom/Medium/4', 'Depth-AmpRoom/Medium/5', 'Depth-AmpRoom/Medium/6', 'Depth-AmpRoom/Medium/7', 'Depth-AmpRoom/Medium/8'];
const audioFileStereo = ['Depth-AmpRoom/stereo-object'];
...
const soundPlayerStereo = new Mach1SoundPlayer(getAudioFiles(audioFileStereo));
...
async function trackerMain() {
  ...
  const waitingSounds = () => new Promise((resolve) => {
    const timer = setInterval(() => {
      ...
      if (Player.isReady() && soundPlayerStereo.isReady()) {
        clearInterval(timer);
        resolve();
      }
    }, 500);
